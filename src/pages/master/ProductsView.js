                        ...
                        <Row>
                            <Col md={3} className={'product-checkout-sidebar'}>
                                ...
                                <Row>
                                    ...
                                    <Col md={12}>
                                        <Button onClick={handleShowPayment} className='w-100'> Check out</Button>
                                        <Modal className='payment-checkout-model' show={showPayment} onHide={handleClosePayment}>
                                            ...
                                            <Modal.Body>
                                                <Row>
                                                    <Col md={6}>
                                                        <LabelField type={'text'} placeholder={'Cash'} label={'Payment method'} />
                                                        <Label className={'bold cus-mt-5'}>Total</Label>
                                                        <h2 className='bold payment-total-h2 cus-mt-5'>$346.2</h2>
                                                    </Col>
                                                    <Col md={6}>
                                                        <LabelField type={'number'} placeholder={'Received amount'} label={'Received amount'} />
                                                        <Label className={'bold cus-mt-5'}>Change</Label>
                                                        <h2 className='bold payment-total-h2 green cus-mt-5'>$0.0</h2>
                                                        <Label className={'bold cus-mt-5'}>Remaining</Label>
                                                        <h2 className='bold payment-total-h2 red cus-mt-5'>$55.0</h2>
                                                    </Col>
                                                </Row>
                                            </Modal.Body>
                                            <Modal.Footer>
                                                ...
                                                <Modal className='product-invoice-model' show={showInvoice} onHide={handleCloseInvoice}>
                                                    <Modal.Header closeButton>
                                                        <Modal.Title>Malpos Invoive</Modal.Title>
                                                    </Modal.Header>
                                                    <Modal.Body>
                                                        <Row>
                                                            <Text className={'text-end f-13'} as={'span'}>Date : 18 june 2023 12:02 am</Text>
                                                        </Row>
                                                        <br />
                                                        <Row>
                                                            <Label className={'cus-mt-5 f-13'}>Area : inside</Label>
                                                            <Label className={'cus-mt-5 f-13'}>Table : Table 5</Label>
                                                        ...
                                                        <Row className='cus-mt-5'>
                                                            <Col md={7}>
                                                                ...
                                                                <List>
                                                                    {myList.map((item, index) => (
                                                                        <li className='f-13' key={index}>{item.name}</li>
                                                                    ))}
                                                                </List>
                                                            </Col>
                                                            <Col md={2}>
                                                                ...
                                                                <List>
                                                                    {myList.map((item, index) => (
                                                                        <li className='f-13' key={index}>{item.qty}</li>
                                                                    ))}
                                                                </List>
                                                                <Label className={'bold f-13'}>Tax Include</Label>
                                                            ...
                                                            <Col md={3}>
                                                                ...
                                                                <List>
                                                                    {myList.map((item, index) => (
                                                                        <li className='f-13' key={index}>{item.subtotal}</li>
                                                                    ))}
                                                                </List>
                                                            ...
                                                            <Col md={12}>
                                                                <CardLayout>
                                                                    <Box className={'total-bill-invoive'}>
                                                                        ...
                                                                        <Box>
                                                                        <Label className={'bold f-13'}>34.34 $</Label>
                                                                        </Box>
                                                                    </Box>
                                                                </CardLayout>
                                                            </Col>
                                    ...
                                    <Row>
                                        ...
                                        <Col md={4}>
                                            <Box className={'search-btn-box'}>
                                                <Button onClick={handleShowCat} className='a'>Seach</Button>
                                                <Modal className={'search-category-model'} show={showCate} onHide={handleCloseCat}>
                                                    <Modal.Header closeButton>
                                                    ...
                                                    <Modal.Body>
                                                        <Row>
                                                            ...
                                                            <button className='cus-btn'>Pasta & Ristto</button>
                                        ...
                                        <Col md={12}>
                                            <Row>
                                                <Col md={4}>
                                                    ...
                                                    <Modal className={'search-product-model'} show={show} onHide={handleClose}>
                                                        <Modal.Header closeButton>
                                                            ...
                                                            <Row>
                                                                <Col md={5}>
                                                                    <Box className={'search-product-model'}>
                                                                        <img src='images/product/single/salad.jpg' alt='img' />
                                                                    </Box>
                                                                </Col>
                                                                <Col md={6}>
                                                                    <Text as={'span'}>$11.23</Text><br />
                                                                    <Text className={'f-13'} as={'span'}>Chicken fillet, cream (animal), corn, cheese, sabalii </Text>
                                                                    <Box className={'cus-mt-5'}>
                                                                        <LabelField type={'number'} placeholder={'0'} label={'Quantity'} />
                                                                    </Box>
                                                                    <Box className={'cus-mt-5'}>
                                                ...
                                                <Col md={4}>
                                                    ...
                                                    <Modal className={'search-product-model'} show={showAdd} onHide={handleCloseAdd}>
                                                        <Modal.Header closeButton>
                                                        ...
                                                        <Modal.Body>
                                                            <Row>
                                                                ...
                                                                <Col md={6}>
                                                                    <Text className={'bold'} as={'span'}>$11.23</Text><br />
                                                                    <Text className={'f-13'} as={'span'}>Chicken fillet, cream (animal), corn, cheese, sabalii </Text>
                                                                    <Box className={'cus-mt-5'}>
                                                                        <Label className={'bold'}>Select your option</Label>
                                                                    </Box>
                                                                    <Box className={'cus-mt-5'}>
                                                                        ...
                                                                        <Row>
                                                                            ...
                                                                            <Col md={12}>
                                                                                <Box className={`select-options`}>
                                                                                    <Label>
                                                                                        <Input type={'checkbox'} />
                                                                                        <Text as={'span'}> &nbsp;Double Decker</Text>
                                                                                    </Label>
                                                                                </Box>
                                                                            </Col>
                                                                            <Box className={'cus-mt-5'}>
                                                                            ...
                                                                            <Label className={'f-13 cus-mt-5'}>
                                                                                <Input type={'checkbox'} />
                                                                                <Text as={'span'}> &nbsp;Peporoni +3.$</Text>
                                                                            </Label>
                                                                            <Label className={'f-13 cus-mt-5'}>
                                                                                <Input type={'checkbox'} />
                                                                                <Text as={'span'}> &nbsp;Olive +4$</Text>
                                                                            </Label>
                                                                            <Label className={'f-13 cus-mt-5'}>
                                                                                <Input type={'checkbox'} />
                                                                                <Text as={'span'}> &nbsp;Mushroom +2$</Text>
                                                                            </Label>
                                                                            <LabelField type={'number'} placeholder={'0'} label={'Quantity'} />
                                                                        </Row>
